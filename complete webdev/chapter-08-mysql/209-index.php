			...
			<div class="collapse navbar-collapse">
				...
				<form class="navbar-form navbar-right" method="post">
					...
					<div class="form-group">
						...
						<input type="email" name="loginemail" placeholder="Your email" class="form-control" value="<?php echo addslashes($_POST['loginemail']); ?>">
					...
					<input class="btn btn-success" name="submit" type="submit" value="Log In"></input>
